...
public class CityMapper {
    @NonNull
    public static City mapCityDbToCity(@NonNull final CityDB cityDB) {
    ...
    @NonNull
    public static CityDB mapCityToCityDb(@NonNull final City city) {
        final CityDB cityDB = new CityDB();
